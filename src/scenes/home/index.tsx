                ...
                className='md:-mt-20 '>
                    <div className='relative'>
                        ...
                        <p className='mt-8 text-sm'>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores officiis laudantium, iste quo numquam magnam cum pariatur labore, ut quis recusandae.
                        </p>
                </motion.div>
                <motion.div 
                initial="hidden"
            ...
            <div className='h-[150px] w-full bg-primary-100 py-10'>
                <div className='mx-auto w-5/6'>
                    <div className='flex w-3/5 items-center justify-between gap-8'>
                        ...
                        <img src={SponsorFotune} alt="redbull-fortune" />
                    </div>
                </div>
            </div>
        )}
